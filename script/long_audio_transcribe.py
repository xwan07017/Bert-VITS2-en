...
if __name__ == "__main__":
    ...
    for file in filelist:
        ...
        for i, seg in enumerate(result['segments']):
            ...
            speaker_annos.append(savepth + "|" + character_name + "|" + lang2token[lang][1:len(lang2token[lang])-1]+"|"+ text)
    ...
    with open("./filelists/long_character_anno.txt", 'w', encoding='utf-8') as f:
